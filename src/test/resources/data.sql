...
INSERT INTO project (id, name, from_date, to_date)
VALUES (1, 'Project 1', '2000-01-02', '2000-12-31'),
       (2, 'Project 2', NULL, NULL);

INSERT INTO employee (id, department_id, first_name, last_name, birth_date, hire_date)
...
INSERT INTO project_employees (projects_id, employees_id)
VALUES (1, 1),
       (2, 2),
       (2, 3);
